...
public class ObjectTrackingActivityEx extends Activity implements ObjectTrackerListener, ExternalRendering {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wikitudeSDK.getTrackerManager().createObjectTracker(targetCollectionResource, ObjectTrackingActivityEx.this, null);
